...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/color.js":[function(require,module,exports) {
"use strict";
...
var _default = ['#FFFFFF', '#FF69B4', '#FF8C00', '#FF9800', '#00FA9A', '#00FFFF', '#00008B', '#808000', '#4B0082', '#000000'];
...
var startBtn = document.querySelector('[data-action="start"]');
...
var ColorPicker = /*#__PURE__*/function () {
  function ColorPicker() {
    ...
    this.isActive = false;
    this.colors = _color.default;
    this.disabledStop();
  }

  _createClass(ColorPicker, [{
    key: "disabledStop",
    value: function disabledStop() {
      stopBtn.disabled = true;
    }
  }, {
    key: "btnStart",
    value: function btnStart() {
      var _this = this;
    ...
    key: "randomIntegerFromInterval",
    value: function randomIntegerFromInterval(min, max) {
      var index = this.colors[Math.floor(Math.random() * (max - min + 1) + min)];
    ...
    key: "startButtonDisable",
    value: function startButtonDisable() {
      startBtn.disabled = true;
      stopBtn.disabled = false;
    }
  }, {
    key: "stopButtonDisable",
    value: function stopButtonDisable() {
